        ...
        <section className="w-full max-w-2xl text-[13px] leading-relaxed">
          <div className="space-y-8">
            ...
            <p>
              ...
              <span className="font-medium">14 days of receipt</span>.
              Returned items must be unused, unworn, and in their original
            ...
            <p>
              If approved, return shipping costs will be reimbursed.
            </p>
            ...
            <p>
              ...
              take up to{" "}
              <span className="font-medium">7 business days</span>.
            </p>
